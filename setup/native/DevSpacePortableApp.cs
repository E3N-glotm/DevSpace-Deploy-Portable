...
";
    ...
    internal sealed class MainForm : Form
    {
        ...
        private void BuildUi()
        {
            ...
            _versionLabel.Text = "DevSpace Portable 1.1.46 · Protocol 1.5";
        ...
        private async Task LoadConfigurationAsync()
        {
            ...
            _versionLabel.Text = "DevSpace Portable " + GetString(_currentConfig, "portableVersion", "1.1.46") + " · Protocol " + GetString(_currentConfig, "protocolVersion", "1.5");
