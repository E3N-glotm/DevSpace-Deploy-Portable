...
";
    ...
    internal sealed class MainForm : Form
    {
        ...
        private void BuildUi()
        {
            ...
            _versionLabel.Text = "DevSpace Portable 1.1.59 dev101 · Protocol 1.6";
        ...
        private async Task LoadConfigurationAsync()
        {
            ...
            _versionLabel.Text = "DevSpace Portable " + GetString(_currentConfig, "portableDisplayVersion", GetString(_currentConfig, "portableVersion", "1.1.59 dev101")) + " · Protocol " + GetString(_currentConfig, "protocolVersion", "1.5");
