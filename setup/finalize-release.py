    ...
    candidates.update(
        {
            ...
            "setup/test-updater-long-path.mjs",
            ...
            "setup/test-legacy-bootstrap-apply.py",
            "setup/test-legacy-bootstrap-policy.py",
            "setup/test-legacy-bootstrap-host.ps1",
            ...
            "app/node_modules/@waishnav/devspace/dist/continuation-supervisor.js",
